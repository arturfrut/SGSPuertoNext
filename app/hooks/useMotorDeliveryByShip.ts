...
const useMotorDeliveryByShip = (selectedShip: string | number) => {
  ...
  useEffect(() => {
    ...
    const fetchDeliveryData = async () => {
      ...
      try {
        const res = await axios.get(`/api/get_motor_delivery/${selectedShip}`)
...
export default useMotorDeliveryByShip
