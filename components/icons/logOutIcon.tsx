export const LogOutIcon = () => (
  ...
  >
    ...
    <g id='SVGRepo_iconCarrier'>
      {' '}
      <title>1105</title> <defs> </defs>{' '}
      <g stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        {' '}
        <g transform='translate(4.000000, 4.000000)' fill='#bd3737'>
          {' '}
          ...
          <path d='M7.46,7.873 C8.238,7.873 8.872,7.393 8.872,6.798 L8.872,1.115 C8.872,0.521 8.238,0.04 7.46,0.04 C6.681,0.04 6.048,0.521 6.048,1.115 L6.048,6.798 C6.048,7.393 6.681,7.873 7.46,7.873 L7.46,7.873 Z'>
            {' '}
          </path>{' '}
        </g>{' '}
      </g>{' '}
