...
import { Button,  CardBody, CardFooter, Divider } from '@nextui-org/react'
import axios from 'axios'
import { useState } from 'react'

export const PoliticsForm = () => {
  const { signatures, handleSaveSignature } = useSignModal()
  const { selectedShip, userId, userData } = useGlobalStore()
  ...
  return (
      <>
        <CardBody className='my-4'>
          ...
          <p className='mb-2 ml-4'>
            4. Brindar el adecuado adiestramiento a todo el personal, a fin de
            que puedan actuar eficientemente ante emergencias, accidentes y
            situaciones de peligro que afecten a la seguridad y al medio
            ambiente.
          </p>
          <p className='mb-2 ml-4'>
            5. Nos comprometemos a promover la integración social fomentando
            grupos de trabajos estables, seguros y justos, y que estén basados
            en la promoción y protección de todos los derechos humanos, así como
            en la no-discriminación, no violencia de género, la tolerancia, el
            respeto de la diversidad, la igualdad de oportunidad, la
            solidaridad, la seguridad y la participación de todas las personas.
            Con ese fin, en el plano Laboral de la Compañía.
          </p>
          <p>
        ...
        <CardBody className='mb-4'>
          ...
          <p>
            ...
            alcohol y el consumo de drogas y otras sustancias similares,
            deteriora el desempeño en el trabajo y es una seria amenaza para la
            salud, la productividad y la seguridad de todo su personal y de la
            empresa.
            <br />
            Con el fin de evitar los riesgos mencionados, aplicamos la siguiente
            política, cuyo estricto cumplimiento es condición de empleo para
            todo su personal:
            <p>
            ...
            <p>
              - Tampoco está permitido distribuir o vender bebidas alcohólicas
            ...
            <p>
              ...
              drogas, se podrá exigir al personal, que se someta a los análisis
              y a las pruebas de dosaje de esas sustancias.
            </p>
            El incumplimiento de esta política dará lugar a sanciones,
            incluyendo la finalización del vínculo laboral.
          </p>
        </CardBody>
        ...
        <CardBody className='mb-4'>
          ...
          <p>
            ...
            <p className='mt-1'>
              ...
              condiciones ambientales son favorables para que se produzcan, lo
              que constituye un riesgo identificado e inaceptable para la
              seguridad de las personas, la embarcación, los bienes y la
              prevención de la contaminación de medio ambiente. Con el fin de
              evitar los riesgos señalados como presidente de la compañía
              dispongo:
            </p>
            <p className='mb-2 mt-2 ml-4'>
              . Prohibido fumar a bordo de las embarcaciones a todas las
              personas que embarquen o cualquier otra persona que deba
              desarrollar, o no, alguna tarea a bordo, en los espacios comunes y
              cerrados. Así mismo no se objetara en los espacios al aire libre.
            </p>
            <p className='mb-2 ml-4'>
        ...
        <CardBody className=' gap-4 mt-3'>
          <div className='w-full  '>
            <p className='text-2xl  my-4'>
              {'Nombre tripulante: ' + userData.name}
            </p>
            <p className='text-2xl my-4'>{'Puesto: Guardia en puerto'}</p>
          </div>
          ...
          <p className='text-sm'>
            ...
            05/2018 TOMO 2 “Normas de Gestión de Seguridad Operacional de Buque
            y la Prevención de la Contaminación (NGS) Cláusula 7 y 02/2011 TOMO
            5. DPSN. ”Control de Alcoholemia al personal de la Marina Mercante
